...
namespace Delegates
{
        ...
        abstract class ShippingDestination
        {
            ...
            public static ShippingDestination getDestinationInfo(string dest)
            {
                ...
                // this new zone 5 handles low-risk shipping destinations by swapping in the appropriate delegate 
                // shipping fee for zone five equals only .02 percent of total shipping cost 
